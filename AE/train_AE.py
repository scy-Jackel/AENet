...
#set load directory
parser.add_argument('--dcm_path', dest='dcm_path', default= '/home/cuiyang/data/zhilin/aapm_data_all', help='dicom file directory')
...
parser.add_argument('--test_patient_no', dest='test_patient_no',type=ut.ParseList, default= 'L067')  # L291 DELETED.
parser.add_argument('--pretrained_vgg', dest='pretrained_vgg', default='../pretrained_vgg19', help='pretrained vggnet directory(only wgan_vgg)')

#set save directory
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir',  default='./ckpt_ae', help='check point dir')
...
parser.add_argument('--alpha', dest='alpha', type=float,  default=1e-6, help='learning rate')
...
# dcm_path = '/home/cuiyang/data/zhilin/aapm_data_all'
# test_patient_no = ['L067']
# train_patient_no = [d.split('/')[-1] for d in glob(dcm_path + '/*') if
#                          ('zip' not in d) & (d.split('/')[-1] not in test_patient_no)]
# print(train_patient_no)
